...
export const VideoTrendsSchema = z.object({
  answer: z
    .string()
    .describe(
      'A clear and concise analysis of the video title idea based on Google Trends data, including whether it is trending, stable, or declining, along with actionable recommendations.',
    ),
});
