...
export const KeywordsSchema = z.object({
  keywords: z
    .array(z.string())
    .describe(
      'The 2 most relevant search keywords extracted from the user question to query Google Trends.',
    ),
});

export type KeywordsData = z.infer<typeof KeywordsSchema>;

// descrição: Prompt do sistema para extrair palavras-chave relevantes da pergunta do usuário.
// chamando a ferramenta google_trends com as palavras-chave extraídas apenas uma vez.
